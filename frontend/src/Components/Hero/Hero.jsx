...
const Hero = () => {
    ...
    const fetchBanners = async () => {
      ...
      try {
        const response = await axios.get(
          "https://goyat-trading-co-1.onrender.com/api/all-banner"
        );
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get(
        "https://goyat-trading-co-1.onrender.com/api/get-product"
      );
  ...
  //   try {
  //     const res = await axios.get("https://goyat-trading-co-1.onrender.com/api/all-articals")
